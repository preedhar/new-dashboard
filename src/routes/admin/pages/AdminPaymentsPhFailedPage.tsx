...
export function AdminSettingsPaymentsPhFailedPage() {
        ...
        <div className="mx-auto flex w-full max-w-[640px] flex-col gap-8">
          ...
          >
            <Card className="items-center gap-4 bg-muted/50 py-8 text-center shadow-none">
              <div className="rounded-xl border border-destructive bg-destructive p-3 shadow-[0_10px_24px_0_rgba(0,0,0,0.10)]">
                <TriangleAlert
              ...
              <div className="space-y-1 px-6">
                <TypographyLarge>
                  Your account setup has some issues
                </TypographyLarge>
